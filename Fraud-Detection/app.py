...
def streamlit_app():
    st.set_page_config(page_title="Fraud-Detection/Credit Card Fraud Detection", layout="wide")
    ...
    if page == "🏠 Home":
        ...
        with col2:
            st.image("Fraud-Detection/fraud_banner.jpg", use_container_width=True)
